...
#   JJohanneson, 11/26/23, Completed Assignment
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    ...
    @property
    def first_name(self) -> str:  # allows reference to all frst name in student instances
        return self._first_name.capitalize()

    @first_name.setter  # safeguards referencing variable, making sure it is not changed to something wrong
    def first_name(self, value: str):
        if value.isalpha():
            self._first_name = value
        else:
            raise ValueError('First name must not contain numbers or symbols, letters only!')
    # mirror first name controls w last name and course
    ...
    def last_name(self, value: str):
        if value.isalpha():
            ...
            raise ValueError('Last name must not contain numbers or symbols, letters only!')
...
class Student(Person):
    ...
    # TODO add the getter and setter for course_name
    @property
    def course(self):
        return self._course.capitalize()
    ...
    def course(self, value: str):
        if value.isalpha():
            ...
            raise ValueError('Course name must not contain numbers or symbols, letters only!')

    # TODO Override the __str__() method to return the Student data (Done)
    def __str__ (self):  # override Person string call
...
class FileProcessor:
    ...
    def read_data_from_file(file_name: str) -> list[Student]:
        ...
        JJohanneson, 11/26/23, Read in dict and convert to Student objects
    ...
    def write_data_to_file(file_name: str, student_data: list):
        ...
        ChangeLog: (Who, When, What)
        RRoot,1.1.2030,Created function
        JJohanneson, 11/26/23, Implement Student object, translate list[Student] to list[dict] for json
        ...
        try:
            ...
            for row in student_data:  # convert list of Student objects to list of dictionaries
...
class IO:
    ...
    JJohanneson,11.26.2023,Changed input student data to us Student object, altered output student data to use Student()
    """
    @staticmethod
    ...
    def output_student_and_course_names(student_data: list[Student]):
        ...
        ChangeLog: (Who, When, What)
        RRoot,1.1.2030,Created function
        JJohanneson,11.26.2023, altered output student data to use Student()
        ...
        for row in student_data:
            ...
            print(f'Student {student_first_name} '
                  f'{student_last_name} is enrolled in {course_name}')
        print("-" * 50)
    ...
    def input_student_data(student_data: list[Student]) -> list[Student]:
        ...
        ChangeLog: (Who, When, What)
        RRoot,1.1.2030,Created function
        JJohanneson,11.26.2023,Changed input student data to use Student object
